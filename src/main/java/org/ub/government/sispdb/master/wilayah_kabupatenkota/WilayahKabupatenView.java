package org.ub.government.sispdb.master.wilayah_kabupatenkota;
...
public class WilayahKabupatenView extends FormTemplate1_IntFrame{
	protected WilayahKabupatenController controller;
	protected WilayahKabupatenModel model;
	 ...
	 */
		...
		public WilayahKabupatenView() {
			super();
			controller = new WilayahKabupatenController(this);
