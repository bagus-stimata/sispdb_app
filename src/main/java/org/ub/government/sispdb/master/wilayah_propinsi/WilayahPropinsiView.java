package org.ub.government.sispdb.master.wilayah_propinsi;
...
public class WilayahPropinsiView extends FormTemplate1_IntFrame{
	protected WilayahPropinsiController controller;
	protected WilayahPropinsiModel model;
	 ...
	 */
		...
		public WilayahPropinsiView() {
			super();
			controller = new WilayahPropinsiController(this);
