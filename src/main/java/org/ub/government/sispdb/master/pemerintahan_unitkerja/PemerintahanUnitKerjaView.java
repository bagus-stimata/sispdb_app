...
public class PemerintahanUnitKerjaView extends FormTemplate1_IntFrame{
	protected PemerintahanUnitKerjaController controller;
	protected PemerintahanUnitKerjaModel model;
	 ...
	 */
		...
		public PemerintahanUnitKerjaView() {
			super();
			controller = new PemerintahanUnitKerjaController(this);
